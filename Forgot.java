 ...
 Connection conn;
    ...
    public void Search(){
        ...
        try{
            ...
            if(rs.next()){
                ...
                jTextField3.setText(rs.getString(3));//eta dekhte hobe v4 time dont know 
                rs.close();
                pst.close();
            }
            else{
    ...
    public void Retrive(){
     ...
     try{
         ...
         rs=pst.executeQuery();
         if(rs.next()){
          jTextField5.setText(rs.getString(5)); //eta dekhte hobe v4 13.55
          //password position of database
         }
         else{
